...
- <p style='float:left;font-size:16px'><b>SARN: Shifted Attention Regression Network for 3D Hand Pose Estimation in Medical Application</b></p> <p style='float: right;font-color:grey; font-size:11px'><i>Feb 2022 – Present</i></p>
...
- <p style='float:left;font-size:16px'><b>ACRNet: Attention Cube Regression Network for Multi-view Real-time 3D Human Pose Estimation in Telemedicine</b></p> <p style='float:right; font-color:grey; font-size:11px'><i>Feb 2022 – Oct 2022</i></p>
