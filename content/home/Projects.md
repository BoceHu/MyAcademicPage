...
<ul><li><p class="left" style='font-size:16px'><b>Glass Cleaning Robot (MECE 4602)</b></p><br/><p style='font-size:16px'><b>Advisor: Sunil K. Agrawal</b></p>
    ...
    <ul><li><p style='text-align: justify;font-size: 14px;'>Analyzed the workspace and the cleaning trajectory of the robot depending on the simulation</p></li></ul>
     <center>
         <figure>  
    <img src="https://github.com/BoceHu/MyAcademicPage/raw/master/assets/media/render.png" alt="render" width="70%" hspace="5">  <figcaption>Render Robotic Arm.</figcaption>
</figure>
    <figure>  
    <img src="https://github.com/BoceHu/MyAcademicPage/raw/master/assets/media/structure.png" alt="structure" width="70%" hspace="5">  <figcaption>Arm Structure.</figcaption>
</figure>
    <figure>
