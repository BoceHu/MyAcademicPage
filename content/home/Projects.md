...
<ul><li><p class="left" style='font-size:16px'><b>Robot Learning (MECE 6616)</b></p><br/><p style='font-size:16px'><b>Advisor: Matei Ciocarlie</b></p>
    ...
    <ul><li><p style='text-align: justify;font-size: 14px;'>Leveraged PyTorch, OpenAi Gym, and Stable-Baselines3 to build the real physcial working environment and train the model to complete different control tasks.</p></li></ul>
    <center>
    <figure>  
