...
<ul><li><p class="left" style='font-size:16px'><b>Dynamic Torque Control of Multi-link Robotic Arms According to End Effector Target positions</b></p><br/>
    ...
    <center>
    <figure>  
    <img class="centerr" src="https://github.com/BoceHu/MyAcademicPage/raw/master/assets/media/project4.gif" alt="project4" width="120%" >  <figcaption style="margin:5px 0px -40px 0px">Deep Q-learning</figcaption>
</figure>
    <figure>
    <img class="centerr" src="https://github.com/BoceHu/MyAcademicPage/raw/master/assets/media/project5.gif" alt="project5" width="120%">  <figcaption style="margin:5px 0px -40px 0px">Proximal Policy Optimization</figcaption>
</figure>
    </center>
    </li></ul>
<ul><li>
